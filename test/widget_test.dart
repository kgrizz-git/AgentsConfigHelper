...
void main() {
  testWidgets('MainShell renders sidebar and content area', (WidgetTester tester) async {
    final configService = ConfigService(backupService: BackupService(backupDirectory: Directory.systemTemp));

    // Build our app and trigger a frame.
    await tester.pumpWidget(AgentsConfigHelperApp(configService: configService));
